...
public partial class SampleObjView : XEntity, IAwake<Transform>, IDestroy
{
...
{
    public SampleObjView View { get; private set; }

    protected override void OnInitComponents()
    {
        this.View = this.Entity.AddComponent<SampleObjView, Transform>(transform);
    }
