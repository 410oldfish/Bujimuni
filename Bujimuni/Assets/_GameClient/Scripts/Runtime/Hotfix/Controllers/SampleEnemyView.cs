...
public partial class SampleEnemyView : XEntity, IAwake<Transform>, IDestroy
{
...
{
    public SampleEnemyView View { get; private set; }

    protected override void OnInitComponents()
    {
        this.View = this.Entity.AddComponent<SampleEnemyView, Transform>(transform);
    }
}