...
public partial class WgtSampleOfScrollViewTitle : UIWidget<WgtSampleOfScrollViewTitle.CPara>
{
    public class ViewComponent : XEntity, IAwake<Transform>, IDestroy
    {
		...
		private UnityEngine.UI.LayoutElement m_SelfLayoutElement;
		public UnityEngine.UI.LayoutElement SelfLayoutElement
		{
			get
			{
				if (Transform == null)
				...
				if (m_SelfLayoutElement == null)
				{
					m_SelfLayoutElement = Transform.GetComponent<UnityEngine.UI.LayoutElement>();
				}
				return m_SelfLayoutElement;
			}
		}
