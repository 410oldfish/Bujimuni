...
public class PercentPositionGearTreeItem: ControllerGearTreeItemBase
{
    ...
    public PercentPositionGearTreeItem(): base(GearTypeState.PercentPosition)
    {
        ...
        StatControllerUtility.GetCanvasSize(out _canvasWidth, out _canvasHeight);
    }
    ...
    public override void OnDetailGUI(int index, Rect itemArea)
    {
        ...
        {
            Rect valueArea = new Rect(itemArea.x + StatControllerEditorUtility.CONTROLLER_PAGE_WIDTH * i +
                (StatControllerEditorUtility.CONTROLLER_PAGE_WIDTH - width) / 2,
                itemArea.y,
                width,
