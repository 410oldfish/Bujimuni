...
public class ControllerTreeItemBase: EditorTreeItemBase
{
    ...
    protected float _addGearHeight = StatControllerEditorUtility.SINGLELINE_HEIGHT + 2;
    ...
    {
        GUI.DrawTexture(itemArea, index % 2 == 1? StatControllerEditorUtility.TreeItemBG1 : StatControllerEditorUtility.TreeItemBG2);
    ...
    public virtual float RebuildAddGearTreeList(List<ControllerTreeItemBase> addGearTreeList)
    {
        ...
        if (_childrenList.Count > 0 && _addGearFoldoutValue)
        {
            ...
            {
                ControllerTreeItemBase controllerTreeItem = _childrenList[i] as ControllerTreeItemBase;
                if (controllerTreeItem.State == ControllerTreeItemState.Hide ||
                    controllerTreeItem.GetChildrenStateNum(ControllerTreeItemState.Hide) > 0)
                {
    ...
    public virtual void RebuildGearConfigList(List<GearConfig> gearConfigList, StatControllerStoredDataBuilder dataBuilder)
    {
