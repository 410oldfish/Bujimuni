...
public class ControllerGearTreeItem: ControllerGearTreeItemBase
{
    ...
    {
        Target.GetComponent<StatController>().EditorChangeControllerSelectedIndex(_controllerName, _values[pageIndex]);
    }
    ...
    {
        if (Target.GetComponent<StatController>() == null)
        {
            return;
        }

        ControllerConfig controllerConfig = Target.GetComponent<StatController>().EditorGetControllerConfig(_controllerName);
