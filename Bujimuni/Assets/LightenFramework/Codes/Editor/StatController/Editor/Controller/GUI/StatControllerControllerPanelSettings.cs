...
public class StatControllerControllerPanelSettings
{
    ...
    public bool InRecordingState
    {
        ...
        set
        {
            ...
            if (value)
            {
                ...
                StatControllerManager.Instance.CurControllerWrapper.RefreshMonitorValue();
            }
    ...
    public void Init()
    {
        _curControllerIndex = StatControllerManager.Instance.CurStatControllerWrapper.ControllerWrapperList.Count > 0? 0 : -1;
        _inEditState = false;
    }
    ...
    public void ChangeCurControllerWrapper(int wrapperIndex)
    {
        ...
        StatControllerManager.Instance.ControllerSettings.Refresh();
