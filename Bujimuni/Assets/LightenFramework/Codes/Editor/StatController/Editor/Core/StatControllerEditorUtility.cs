...
using System.IO;
    ...
    public enum StatControllerGameObjectType : int
    {
        None,
        PrefabAsset,
        PrefabInstance,
...
public class StatControllerEditorUtility
{
    /// <summary>
    /// 编辑器最小宽度
    /// </summary>
    ...
    /// 编辑器资源根目录
    /// </summary>
    public const string EDITOR_ASSETS_PATH = "Assets/Editor/StatController/Editor Resources/Image/";
    ...
    {
        {
            ...
            new List<string> { "public override void SetVector2(Vector2 value)", "_target.{0} = value;", "base.SetVector2(value);" }
        },
        {
            (int)LinkerValueState.Vector3,
            new List<string> { "public override void SetVector3(Vector3 value)", "_target.{0} = value;", "base.SetVector3(value);" }
        },
        {
            (int)LinkerValueState.Quaternion,
            new List<string> { "public override void SetQuaternion(Quaternion value)", "_target.{0} = value;", "base.SetQuaternion(value);" }
        },
        {
            (int)LinkerValueState.Boolean,
            new List<string> { "public override void SetBoolean(bool value)", "_target.{0} = value;", "base.SetBoolean(value);" }
        },
        {
            (int)LinkerValueState.Int32,
            new List<string> { "public override void SetInt32(int value)", "_target.{0} = value;", "base.SetInt32(value);" }
        },
        {
            (int)LinkerValueState.String,
            new List<string> { "public override void SetString(string value)", "_target.{0} = value;", "base.SetString(value);" }
        },
        {
            (int)LinkerValueState.Single,
            new List<string> { "public override void SetSingle(float value)", "_target.{0} = value;", "base.SetSingle(value);" }
        },
        {
            (int)LinkerValueState.Color,
            new List<string> { "public override void SetColor(Color value)", "_target.{0} = value;", "base.SetColor(value);" }
        },
        {
            (int)LinkerValueState.Sprite,
            new List<string> { "public override void SetSprite(Sprite value)", "_target.{0} = value;", "base.SetSprite(value);" }
        },
        {
            (int)LinkerValueState.Char,
            new List<string> { "public override void SetChar(char value)", "_target.{0} = value;", "base.SetChar(value);" }
        },
        {
            (int)LinkerValueState.Rect,
            new List<string> { "public override void SetRect(Rect value)", "_target.{0} = value;", "base.SetRect(value);" }
        },
        {
            (int)LinkerValueState.SystemObject,
            new List<string> { "public override void SetSystemObject(System.Object value)", "_target.{0} = value;", "base.SetSystemObject(value);" }
        },
        {
            (int)LinkerValueState.UnityEvent, new List<string>
            {
                // add
        ...
        {
            (int)LinkerValueState.UnityEventBoolean, new List<string>
            {
        ...
        {
            (int)LinkerValueState.UnityEventSingle, new List<string>
            {
        ...
        {
            (int)LinkerValueState.UnityEventInt32, new List<string>
            {
        ...
        {
            (int)LinkerValueState.UnityEventString, new List<string>
            {
        ...
        {
            (int)LinkerValueState.UnityEventVector2, new List<string>
            {
