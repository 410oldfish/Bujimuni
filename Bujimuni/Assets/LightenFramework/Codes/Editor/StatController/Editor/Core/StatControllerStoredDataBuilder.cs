...
public class StatControllerStoredDataBuilder
{
    ...
    public ushort GetGameObjectIndex(GameObject target)
    {
        if (target == null)
        {
            return StatControllerUtility.FalseValue;
        }
    ...
    public List<ushort> BuildDataList(GameObject target, List<bool> values)
    {
        ...
        for (int i = 0; i < values.Count; i++)
        {
            dataList.Add(values[i]? StatControllerUtility.TrueValue : StatControllerUtility.FalseValue);
        }
    ...
    public List<ushort> BuildDataList(GameObject target, string binderType, string linkerType, string label, string assetPath)
    {
        List<ushort> dataList = new List<ushort>();
        dataList.Add(GetGameObjectIndex(target));
        dataList.Add(GetStringIndex(binderType));
        dataList.Add(GetStringIndex(linkerType));
        dataList.Add(GetStringIndex(label));
        dataList.Add(GetStringIndex(assetPath));
        return dataList;
    }
    ...
    AnimationCurve curve = null)
    {
        ...
        for (int i = 0; i < valueSize; i++)
        {
            dataList.Add(actives[i]? StatControllerUtility.TrueValue : StatControllerUtility.FalseValue);
        }
    ...
    public List<ushort> BuildDataList(GameObject target, int frameIndex, int valueSize, List<float> values, List<bool> actives, bool hasTween = false,
    EaseType easeType = EaseType.Linear)
    {
        List<ushort> dataList = new List<ushort>();
        dataList.Add(GetGameObjectIndex(target));
    ...
    public void Store(StatController uiexpansion)
    {
