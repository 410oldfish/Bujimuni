...
public class ScaleGear: GearBase
{
    private RectTransform _target;

    private Vector3[] _values;

    public ScaleGear(Controller parent, GearConfig config): base(parent, config)
    {
    }
    ...
    {
        base.Apply();
        _target.localScale = _values[_parent.SelectedIndex];
    }
}