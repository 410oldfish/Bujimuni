...
public class SizeDeltaKeyFrame: ValuesKeyFrameBase
{
    ...
    public override bool ApplyValue(TransitionTweenAction tweenAction)
    {
        ...
        Vector2 value = new Vector2(tweenAction.Actives[0]? tweenAction.Value[0] : _target.sizeDelta.x,
    ...
    public override void ApplyValue()
    {
        if (_target != null)
        {
            Vector2 value = new Vector2(_actives[0]? _values[0] : _target.sizeDelta.x,
