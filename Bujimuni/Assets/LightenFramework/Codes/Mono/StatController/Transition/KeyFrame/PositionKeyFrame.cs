...
public class PositionKeyFrame: ValuesKeyFrameBase
{
    ...
    public override bool ApplyValue(TransitionTweenAction tweenAction)
    {
        ...
        Vector3 position = new Vector3(tweenAction.Actives[0]? tweenAction.Value[0] : _target.localPosition.x,
    ...
    public override void ApplyValue()
    {
        if (_target != null)
        {
            Vector3 position = new Vector3(_actives[0]? _values[0] : _target.localPosition.x,
