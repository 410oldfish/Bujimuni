...
public class Transition
{
    ...
    public UnityAction<string> OnStringEvent
    {
        get => _onStringEvent;
    }

    public Transition(StatController owner, TransitionConfig config)
    {
        _owner = owner;
        _name = config.name;
        ...
        {
            KeyFrameBase keyframe = StatControllerUtility.GetKeyFrame(this, config.keyFrameConfigs[i]);
